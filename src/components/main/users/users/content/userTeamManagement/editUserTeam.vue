    ...
    <div class="content">
        <div>
          ...
          <div class="add-li">
            ...
            <div class='li-item'>
              用户组名称：
              <el-input @focus="clearError"  placeholder="请输入用户名" v-model="groupName" clearable></el-input>
            </div>
            <div class='li-item'>
              菜单id：
              <el-input @focus="clearError"  placeholder="请输入用户密码"  type='password' v-model="schemeId" clearable></el-input>
            </div>
            <!-- <div class="button confirm-button">确认</div> -->
            <div class='btn-li'><el-button class='btn' type="primary" @click='editUser'>确认</el-button></div>
          </div>
        </div>
      </div>
  </div>
