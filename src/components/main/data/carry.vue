...
<template>
  <div class="data-warp">
    <div class="top-bar">
      ...
      <div class="bar1">
        <div class="data_btn">
          <a href="api/emergency/export?userTypeId=1002">数据导出</a>
        </div>
        <div class="data_btn">
          <a href="api/emergency/template?userTypeId=1002">模板下载</a>
        </div>
        ...
        <div class="limit-edit-popupd">
          <div class="limit-edit-popup-contentd">
            ...
            <div class='li-itemd'>
              ...
              <div>
                地区：
                <el-input clearable v-model="addcountyName" placeholder="请输入用户地区"></el-input>
              </div>
              <div>
                乡镇：
        ...
        <div class="limit-edit-popupd">
          <div class="limit-edit-popup-contentd">
            ...
            <div class='li-itemd'>
              ...
              <div>
                地区：
                <el-input clearable v-model="editcountyName" placeholder="请输入用户地区"></el-input>
              </div>
              <div>
                乡镇：
